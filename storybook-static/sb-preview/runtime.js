            ...
            (l = [
              {
                ...
                value: function (e2) {
                  var t3,
                    ...
                    b2 = i()
                  p === "chrome" &&
                    typeof (b2 == null || (t3 = b2.brave) === null || t3 === void 0 ? void 0 : t3.isBrave) ==
                      "function" &&
                    (p = "brave"),
                    p && (s2[p] = !0),
                    w2 && (s2[w2] = !0)
...
var B = Object.create,
  ...
  v = (r, e, n) => (
    (n = r != null ? B(h(r)) : {}), E(e || !r || !r.__esModule ? R(n, "default", { value: r, enumerable: !0 }) : n, r)
  ),
  x = I((T) => {
      ...
      ;(this.lastFileName = 0),
        ...
        (this.addParameters = ({ globals, globalTypes, ...parameters }) => {
          ;(this.facade.projectAnnotations.parameters = combineParameters(
            ...
            globals &&
              (this.facade.projectAnnotations.globals = { ...this.facade.projectAnnotations.globals, ...globals }),
            globalTypes &&
