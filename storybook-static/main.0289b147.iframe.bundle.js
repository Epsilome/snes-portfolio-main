  ...
  [179],
  {
    "./components lazy recursive ^\\.\\/.*$ include: (?:[\\\\/]components(?:[\\\\/](?%21\\.)(?:(?:(?%21(?:^%7C[\\\\/])\\.).)*?)[\\\\/]%7C[\\\\/]%7C$)(?%21\\.)(?=.)[^\\\\/]*?\\.stories\\.(js%7Cjsx%7Cts%7Ctsx))$":
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          "./Button/Button.stories": ["./components/Button/Button.stories.tsx", 423, 228],
          "./Button/Button.stories.tsx": ["./components/Button/Button.stories.tsx", 423, 228],
        }
    ...
    "./.storybook/preview.ts": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      injectStylesIntoStyleTag_default()(tailwind.Z, options)
      tailwind.Z && tailwind.Z.locals && tailwind.Z.locals
