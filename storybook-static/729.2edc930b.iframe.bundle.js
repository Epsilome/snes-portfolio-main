  ...
  [729],
  {
    "./node_modules/@storybook/blocks/dist/Color-6VNJS4EI.mjs": (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, { ColorControl: () => ColorControl, default: () => Color_default })
          ...
          var a = o.onMove,
            ...
            x = (0, react.useMemo)(
              function () {
                var e = function (e) {
                    h(e),
                      (f(e) ? e.touches.length > 0 : e.buttons > 0) && m.current ? g(d(m.current, e, b.current)) : t(!1)
                  },
                  r = function () {
                    return t(!1)
                  }
      ...
      var R,
        ...
        PickerTooltip = (0, dist.zo)(components_dist.Rl)({ position: "absolute", zIndex: 1, top: 4, left: 4 }),
        ...
        Note = (0, dist.zo)(components_dist.gu)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })),
        ...
        ColorControl = ({ name, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = !1 }) => {
          let throttledOnChange = (0, react.useCallback)(throttle_default()(onChange, 200), [onChange]),
            ...
            { presets, addPreset } = ((presetColors, currentColor, colorSpace) => {
              let [selectedColors, setSelectedColors] = (0, react.useState)(currentColor?.valid ? [currentColor] : [])
              ;(0, react.useEffect)(() => {
