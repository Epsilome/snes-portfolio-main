        ...
        return (
          (wrapped.cancel = function () {
            ...
            try {
              ...
              wrappedInteractions.forEach(function (interaction) {
                interaction.__count--,
                  subscriber && interaction.__count === 0 && subscriber.onInteractionScheduledWorkCompleted(interaction)
              })
            }
          }),
          wrapped
              ...
              if (
                ...
                if (_progressedPrimaryChild !== currentPrimaryChildFragment.child) {
                  ...
                  for (var _progressedChild2 = _progressedPrimaryChild; _progressedChild2 !== null; )
                    (_progressedChild2.return = _primaryChildFragment2), (_progressedChild2 = _progressedChild2.sibling)
                }
              }
    ...
    for (var _key in obj) {
      ...
      if (typeof value != "object")
        registered != null && registered[value] !== void 0
          ...
          : isProcessableValue(value) && (string += processStyleName(_key) + ":" + processStyleValue(_key, value) + ";")
      else {
