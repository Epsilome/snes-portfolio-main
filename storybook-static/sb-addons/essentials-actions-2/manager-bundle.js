try {
  ;(() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e) if (((a = n), (a && typeof a == "object" && ((a = Me(t, a)), !a)) || !t.has(a))) return !1
          return !0
        }
        if (r === Map) {
          if (e.size !== t.size) return !1
          for (n of e)
            if (((a = n[0]), (a && typeof a == "object" && ((a = Me(t, a)), !a)) || !L(n[1], t.get(a)))) return !1
          return !0
        }
        ...
        if (!r || typeof e == "object") {
          n = 0
          for (r in e) if ((De.call(e, r) && ++n && !De.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1
    ...
    var Fs = _(Pt)
    function Ft(e, t) {
      return t === "transparent" ? t : C(T({}, R(t), { lightness: parseFloat(e) }))
    }
    var zs = _(Ft)
    function zt(e, t) {
      return t === "transparent" ? t : C(T({}, R(t), { saturation: parseFloat(e) }))
    }
    var Hs = _(zt)
    function Ht(e, t) {
    ...
    var kt = Object.create,
      ...
      Yt = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of Ze(t))
            !Vt.call(e, a) && a !== r && pe(e, a, { get: () => t[a], enumerable: !(n = Gt(t, a)) || n.enumerable })
        return e
      },
      Jt = (e, t, r) => (
        (r = e != null ? kt(Wt(e)) : {}),
        Yt(t || !e || !e.__esModule ? pe(r, "default", { value: e, enumerable: !0 }) : r, e)
      ),
      qt = fe({
    ...
    var rr = (e) => Array.from({ length: e }, (t, r) => [X].concat(Array.from({ length: r }, () => "*")).join(".")),
      nr = (e, t, r, n, a) => {
        let i = []
            .concat(rr(n))
            .concat(r)
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, d, f) => {
                ...
                else if (E === Ye) for (let { name: m, data: y } of t(p)) J(y, t) && c(y, `${d}.${m}`, f + 1)
                else {
                  let m = p[E]
                  J(m, t) && c(m, `${d}.${E}`, f + 1)
                }
      ...
      tt = j(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        let s = A("TreeView"),
          l = U({}),
          [, u] = l
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(et, { name: e, data: t, dataIterator: r, depth: 0, path: X, nodeRenderer: n })
            )
          )
        )
      }),
    ...
    var ue = ({ data: e }) => {
      ...
      ir = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        ...
        return o.createElement(
          "span",
          null,
          typeof e == "string" ? o.createElement(me, { name: e, dimmed: r }) : o.createElement(ue, { data: e }),
          o.createElement("span", null, ": "),
    ...
    var fr = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Nr = ({ children: e, className: t }) => o.createElement(Le, { horizontal: !0, vertical: !0, className: t }, e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                let n = [...r.actions],
                  a = n.length && n[0]
                return (
                  a && Pr(a.data, t.data) ? a.count++ : ((t.count = 1), n.unshift(t)),
